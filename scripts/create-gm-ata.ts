...
(async () => {
  ...
  if (info) { console.log('already exists'); return; }
  const ix = createAssociatedTokenAccountInstruction(payer.publicKey, ata, PROVIDER, USDC, TOKEN_PROGRAM_ID, ASSOCIATED_TOKEN_PROGRAM_ID);
